...
export class FolderManager {
  ...
  private createHeader(): HTMLElement {
    ...
    // Cloud sync/upload actions intentionally omitted in GeminiMate local-only mode.
  ...
  private createFolderElement(folder: Folder, level = 0): HTMLElement {
    ...
    folderEl.dataset.pinned = folder.pinned ? 'true' : 'false';
    ...
    expandBtn.innerHTML = folder.isExpanded
      ? '<span class="google-symbols" data-icon="expand_more">expand_more</span>'
      : '<span class="google-symbols" data-icon="chevron_right">chevron_right</span>';
    ...
    actionsBtn.innerHTML = '<span class="google-symbols" data-icon="more_vert">more_vert</span>';
  ...
  private setupStorageListener(): void {
    ...
    browser.storage.onChanged.addListener((changes, areaName) => {
      ...
      // Listen for external folder data changes and refresh local UI state
    ...
    // Listen for explicit reload messages from extension pages
