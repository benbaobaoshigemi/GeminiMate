...
export const StorageKeys = {
    ...
    GRAPH_EXPORT_QUALITY: 'geminimate_graph_export_quality',
    ...
    NETWORK_QUALITY_ENABLED: 'geminimate_network_quality_enabled',
    NETWORK_QUALITY_SNAPSHOT: 'geminimate_network_quality_snapshot',
    NETWORK_QUALITY_THRESHOLDS: 'geminimate_network_quality_thresholds',
