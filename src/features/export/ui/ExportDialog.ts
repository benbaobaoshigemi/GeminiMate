...
export class ExportDialog {
  ...
  private createDialog(options: ExportDialogOptions): HTMLElement {
    ...
    eyebrow.className = 'gv-export-dialog-eyebrow';
    eyebrow.textContent = 'GeminiMate';
    ...
    // Format options
    const formatHeader = this.createSectionHeader(
      this.normalizeSectionTitle(options.translations.selectFormat),
      '↓',
    );
    ...
    dialog.appendChild(formatHeader);
  ...
  private createFormatOption(
    ...
    icon.className = 'gv-export-format-icon';
    icon.textContent = this.getFormatIcon(formatInfo.format);
  ...
  private createFontSizeSection(options: ExportDialogOptions): HTMLElement {
    ...
    const sectionHeader = this.createSectionHeader(
      this.normalizeSectionTitle(options.translations.fontSizeLabel),
      'T',
    );
  ...
  private createSectionHeader(title: string, iconText: string): HTMLElement {
    const header = document.createElement('div');
    header.className = 'gv-export-section-header';

    const icon = document.createElement('span');
    icon.className = 'gv-export-section-icon';
    icon.textContent = iconText;

    const text = document.createElement('span');
    text.className = 'gv-export-section-title';
    text.textContent = title;

    const line = document.createElement('span');
    line.className = 'gv-export-section-line';
